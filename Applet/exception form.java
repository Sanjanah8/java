...
public class ApplicationFormm extends Applet implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submitButton) {
            ...
            if (detailsAlreadyExist(name)) {
                showMessage("Details already exist for " + name + ".");
            } else {
                if (writeToFile(name, address, password, course, hobbies)) {
    ...
    private String getSelectedHobbies() {
        ...
        if (cooking.getState()) selectedHobbies.append("Cooking, ");
        if (drawing.getState()) selectedHobbies.append("Drawing, ");
        if (playing.getState()) selectedHobbies.append("Playing, ");
        if (music.getState()) selectedHobbies.append("Listening to music, ");
    ...
    private boolean detailsAlreadyExist(String name) {
        File file = new File(name + ".txt"); 
        return file.exists();
    }

    private boolean writeToFile(String name, String address, String password, String course, String hobbies) {
